...
1. Only genes that caused a depletion score of -0.25 or lower in at least one cell line were used. This decreased the number of genes used from `r genes_total` to `r genes_used`.
